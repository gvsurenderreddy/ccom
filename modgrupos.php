 ...
 * Gestion de grupos
 *
 * Alta/Baja/modificación de grupos
 * @package ecomm-core
 */
...
$page->addVar('headers', 'titulopagina', $trans->_('Gestion de grupos'));
$page->addVar('page', 'labelalta', $trans->_("Alta de grupos") );
...
if ($mostrarEdicion){
	...
	$page->setAttribute( 'edicion', 'src', 'edicion_grupos.txt' );
	...
	$page->addVar( 'edicion', 'optionsselectprofile', genComboProfiles($group->get("id_profile"), array("id"=>1) ) );
...
if ($mostrarListado){
	...
	$page->setAttribute( 'listado', 'src', 'listado_grupos.txt' );
